...
export default function Home() {
  return (
    <main className="bg-[url('/Tim.png')] font-jakarta bg-cover bg-center min-h-screen flex flex-col justify-between pt-[60px] pb-[80px] items-center text-black backdrop-blur-[20px] overflow-hidden">
      <div
        data-aos="fade-down"
