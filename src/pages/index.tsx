  ...
  return (
    <>
      <Head>
        ...
        <link rel="preload" href="/Tim.webp" as="image" />
      </Head>
      <main className="bg-[url('/Tim.webp')] font-jakarta bg-cover bg-center min-h-screen flex flex-col justify-between pt-[40px] md:pt-[60px] pb-[40px] md:pb-[80px] items-center text-black backdrop-blur-[20px] overflow-hidden">
        <div
          data-aos="fade-down"
